GLOG_logtostderr=1 bazel-bin/mymediapipe/examples/desktop/ik_opengl/ik_opengl_pose_demo \
        --calculator_graph_config_file=mymediapipe/graphs/ik_opengl/ik_opengl_pose.pbtxt \
