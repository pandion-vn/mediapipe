...
class GlShaderCalculator : public CalculatorBase {
public:
    GlShaderCalculator() : initialized_(false) {}
    GlShaderCalculator(const GlShaderCalculator&) = delete;
    GlShaderCalculator& operator=(const GlShaderCalculator&) = delete;
    ~GlShaderCalculator() override = default;
...
// static
absl::Status GlShaderCalculator::GetContract(CalculatorContract* cc) {
...
absl::Status GlShaderCalculator::Open(CalculatorContext* cc) {
...
absl::Status GlShaderCalculator::Process(CalculatorContext* cc) {
...
absl::Status GlShaderCalculator::Close(CalculatorContext* cc) {
