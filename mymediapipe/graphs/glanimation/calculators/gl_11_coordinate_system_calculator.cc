...
class Gl11CoordinateSystemCalculator : public GlBaseCalculator {
public:
...
REGISTER_CALCULATOR(Gl11CoordinateSystemCalculator);

absl::Status Gl11CoordinateSystemCalculator::GlSetup() {
...
absl::Status Gl11CoordinateSystemCalculator::GlBind() {
...
absl::Status Gl11CoordinateSystemCalculator::GlRender(const GlTexture& src, const GlTexture& dst, 
                                              double timestamp) {
...
absl::Status Gl11CoordinateSystemCalculator::GlCleanup() {
    // cleanup
...
absl::Status Gl11CoordinateSystemCalculator::GlTeardown() {
    if (program_) {
